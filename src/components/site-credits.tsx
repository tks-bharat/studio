      ...
      <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
        <div className="flex-1">
          ...
          <p className="mt-2 text-muted-foreground max-w-prose">
            A selected member of the faculty cohort for Stanford, a Neo4j Certified Professional, and a Microsoft Certified person who is pursuing Data Science & Artificial Intelligence. I am serving as Chief Advisor of FinTech Society and founded the society.
          </p>
        </div>
      </div>
    </div>
